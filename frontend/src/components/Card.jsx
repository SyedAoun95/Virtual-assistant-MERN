...
function Card({image}) {
  ...
  return (
    ...
    <div className={` w-[70px] h-[160px] lg:w-[140px] lg:h-[250px] bg-[#020220] border-2 border-[#8686865f] rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-blue-700 cursor-pointer hover:border-4 hover:border-white ${selectedImage==image?"border-4 border-white shadow-2xl shadow-blue-700":null}`} onClick={()=>setSelectedImage(image)}>
